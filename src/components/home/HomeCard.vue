  ...
  <div class="home-card">
    <div class="home-card-inner">
      <div class="user-info">
        ...
        <div class="shelf-text">你近期参与了{{data.num}}个活动</div>
        <div class="round-item"></div>
        <div class="shelf-text">哈哈哈哈</div>
      </div>
      <div class="book-info">
      ...
      <div class="feedback-text" @click="toUserInputClick">反馈</div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toUserInputClick() {
        this.$router.push({path: '/pages/userInput/main'})
      }
    }
  }
</script>
